                                                    ...
                                                    <form class="" action="edit_kgb.php" method="get">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="kgb_terakhir"
                                                                class="form-control" value="<?php echo $d->kgb_terakhir; ?>">
                                                        </div>
                                                        <div class="form-group">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form data-parsley-validate class="form-horizontal form-label-left"
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">KGB
                                                    Terakhir</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">KGB yang akan
                                                    datang
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" type="date"
