<nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    <div class="flex ml-auto items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <button type="button" class="gap-3 flex text-sm rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
          ...
          <div class="my-auto mx-auto">
            <p><strong>{{ Auth::user()->pegawai->nama_pegawai }}</strong></p>
          </div>
        </button>
        <!-- Dropdown menu -->
