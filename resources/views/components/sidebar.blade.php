...
<div class="menu_section">
  ...
  <ul class="nav side-menu">
      <li><a href="#" style="text-decoration: none;"><i class="fa fa-home"></i> Dashboard</a></li>
  </ul>
</div>
  ...
  <ul class="nav side-menu">
      ...
      <li>
          ...
          <ul class="collapse list-unstyled px-5 pb-2" id="pengajuanCutiSubmenu">
              <li class=""><a href="index.php?page=ajukan_cuti" style="text-decoration: none;">Ajukan Cuti</a></li>
              <li><a href="index.php?page=daftar_approval" style="text-decoration: none;">Menunggu Approval</a></li>
          </ul>
      </li>

      <!-- Dropdown Data Pengajuan Cuti -->
      <li>
          <a href="#dataPengajuanCutiSubmenu" data-toggle="collapse" aria-expanded="false" style="text-decoration: none;">
