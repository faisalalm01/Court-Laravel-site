                ...
                <table id="data-tables" class="min-w-full table-auto border-collapse">
                    ...
                    <tbody>
                        @foreach ($data as $user)
                            ...
                            <!-- Modal -->
                            <div id="modalviewuser{{ $user->nip }}" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
                                <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl">
                                    <div class="p-6">
                                        <h3 class="text-xl font-bold mb-4">Detail User - {{ $user->pegawai->nama_pegawai }}</h3>
                                        <!-- Konten modal -->
                                        <div class="space-y-3">
