                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"
                                        value="<?php echo $data['lama_cuti']; ?> <?php echo $data['ket_lama_cuti']; ?> " readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">Tanggal Mulai Cuti</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $data['dari_tanggal']; ?> " readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">Tanggal Akhir Cuti</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="<?php echo $data['sampai_dengan']; ?> " readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control"
                                        value="<?php echo $data['status_cuti']; ?> <?php echo $data['ket_status_cuti']; ?> " readonly>
                                </div>
                            </div>
