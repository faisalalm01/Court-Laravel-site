                ...
                <tbody>
                    @foreach ($cutiTahunIni as $c)
                        <tr>
                            ...
                            <td class="px-4 py-2 text-center font-semibold text-green-600">{{ $c->jatah - $c->terpakai }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                        ...
                        @if (Auth::user()->role === 'Admin')
                            @foreach ($dataPeg as $user)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">
                                        <a href="#" class="bg-green-500 rounded-md px-2 py-1 text-xs text-white"
                                            data-modal-toggle="pegawaidetail{{ $user->nip }}">lihat detail</a>
                                    </td>
                                    <td class="py-3 px-4">
                                        <a href="#"
                                            class="bg-green-500 rounded-md px-2 py-1 text-xs text-white">lihat
                                            detail</a>
                                    </td>
                                    <td class="py-3 px-4">
                                        <a href="#"
                        ...
                        @else
                            @foreach ($data as $d)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">
                                        <span
                                            class="px-2 py-1 rounded {{ $d->status_cuti === 'Disetujui' ? 'bg-green-200 text-green-800' : ($d->status_cuti === 'Ditangguhkan' ? 'bg-orange-200 text-orange-800' : ($d->status_cuti === 'Perubahan' ? 'bg-blue-200 text-blue-800' : 'bg-red-200 text-red-800')) }}">
                                            {{ $d->status_cuti }}
                                        </span>
                                    </td>
                                    <td class="py-3 px-4">
            ...
            <div id="pegawaidetail{{ $user->nip }}"
                ...
                <div class="bg-white rounded-lg shadow-xl mx-auto my-10">
                    <div class="p-6">
                        ...
                        <table class=" table-auto border-collapse">
                            ...
                            <tbody class="text-center">
                                @php
                                    $cutiList = \App\Models\CutiPegawai::where(
                                        'id_pegawai',
                    ...
                    <div class="bg-gray-50 px-6 py-3 flex justify-end">
                        <button type="button" data-modal-hide="pegawaidetail{{ $user->nip }}"
