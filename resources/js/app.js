    ...
    if (table && typeof DataTable !== 'undefined') {
        ...
        setTimeout(() => {
            ...
            paginationButtons.forEach(btn => {
                btn.classList.add(
                    'px-3', 'py-1', 'mx-1', 'rounded', 'bg-white', 'border',
                    'border-gray-300', 'hover:bg-gray-100', 'text-gray-700'
                );
            });

            // Active pagination button
            const activePageButton = document.querySelector('.dataTable-pagination a.active');
            if (activePageButton) {
                activePageButton.classList.add('bg-blue-500', 'text-white', 'border-blue-500');
            ...
            if (dataTableTop) {
                dataTableTop.classList.add('flex', 'flex-col', 'md:flex-row', 'items-center', 
            ...
            if (dataTableBottom) {
                dataTableBottom.classList.add('flex', 'flex-col', 'md:flex-row', 
                                           'items-center', 'justify-between', 'gap-4', 'mt-4');
            }
        }, 100);
    }
}
